...
export default ts.config(
  ...
  ...svelte.configs["flat/prettier"],
  {
    ...
    rules: {
      ...
      // - no-navigation-without-resolve: routes are served by the embedded SPA fallback
      ...
      // The Web edition must not reintroduce Tauri browser dependencies.
          ...
          patterns: [
            {
              ...
              message: "The Web edition uses WebSocket transport and cannot import Tauri APIs.",
            },
          ],
        },
      ],
